...
uint256 hashGenesisBlock("0x0000000076a2a3b44aa2b77da6212dab1269a63ec6958a2a6c77761b4529e37b");
...
const string strMessageMagic = "Ferengicoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000076a2a3b44aa2b77da6212dab1269a63ec6958a2a6c77761b4529e37b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1393700500;
        block.nBits    = 486604799;
        block.nNonce   = 1211883525;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FerengicoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FerengicoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("FerengicoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running FerengicoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FerengicoinMiner terminated\n");
        throw;
    }
}
